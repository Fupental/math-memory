...
DATA=${DATA:-/home/fu_zhihang/projects/LeverLM/data/leverlm_math_memory_mixed_random32_semantic32_5k_seed42_main4_gpu2_20260517_070632/generated_data/math_memory_mixed_random32_semantic32_shot2_beam5_seed42_scored.json}
CACHE=${CACHE:-/home/fu_zhihang/projects/LeverLM/data/leverlm_math_memory_anchor400_r1/cache/math_memory_embeddings}
RUN_DIR=${RUN_DIR:-/home/fu_zhihang/projects/LeverLM/data/leverlm_math_memory_pointer_rce_mixed32_32_valacc_20seeds_$(date +%Y%m%d_%H%M%S)}
CKPT_DIR=${CKPT_DIR:-${RUN_DIR}/model_cpk/pointer_rce_mixed32_32_valacc}
...
python math_memory_pointer_train.py \
  ...
  --eval-candidate-mode mixed \
  --candidate-seed "$VAL_CANDIDATE_SEED" \
  --candidate-num 64 \
  --random-candidate-num 32 \
  --semantic-candidate-num 32 \
...
for candidate_seed in $CANDIDATE_SEEDS; do
  echo "===== Evaluate mixed candidate_seed=${candidate_seed} ====="
