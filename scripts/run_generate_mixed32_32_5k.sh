...
RUN_DIR=${RUN_DIR:-/home/fu_zhihang/projects/LeverLM/data/leverlm_math_memory_mixed_random32_semantic32_5k_seed42}
OUT=${OUT:-${RUN_DIR}/generated_data/math_memory_mixed_random32_semantic32_shot2_beam5_seed42_scored.json}
...
python math_memory_generate_mixed.py \
