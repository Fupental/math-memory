...
RUN_DIR=${RUN_DIR:-/home/fu_zhihang/projects/LeverLM/data/leverlm_math_memory_semantic_topk_chunks_20k_seed42}
OUT=${OUT:-${RUN_DIR}/generated_data/math_memory_semantic_topk_chunks_shot2_cand64_repeat4_beam5_seed42_scored.json}
