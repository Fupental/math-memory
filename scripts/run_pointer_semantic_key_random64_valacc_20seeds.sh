...
RUN_DIR=${RUN_DIR:-/home/fu_zhihang/projects/LeverLM/data/leverlm_math_memory_pointer_rce_random64_semantic_key_valacc_20seeds_$(date +%Y%m%d_%H%M%S)}
CKPT_DIR=${CKPT_DIR:-${RUN_DIR}/model_cpk/pointer_rce_random64_semantic_key_valacc}
