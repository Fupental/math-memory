...
DATA=${DATA:-/root/autodl-tmp/leverlm_math_memory_anchor400_r1/generated_data/math_memory_shot2_cand64_repeat1_beam5_seed42_scored.json}
...
RESULT_ROOT=${RESULT_ROOT:-/root/autodl-tmp/rce_temperature_search_$(date +%Y%m%d_%H%M%S)}
